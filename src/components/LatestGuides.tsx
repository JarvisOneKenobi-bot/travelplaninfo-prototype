  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="text-sm text-gray-900 hover:text-amber-600 transition-colors">
          All articles →
        </button>
      </div>
        ...
        <div className="w-72 shrink-0 space-y-5">
            ...
            <div className="space-y-4">
              {recentPosts.map((post) => (
                <div key={post.title} className="flex items-start gap-3">
                  <div className="w-12 h-12 rounded-lg bg-amber-200 shrink-0" />
                  <div>
          ...
          <div className="bg-amber-50 rounded-xl p-5">
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg mb-3 focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white"
            />
            <button className="w-full py-2.5 text-sm font-medium text-white rounded-lg bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 transition-all">
              Subscribe
            </button>
          </div>
